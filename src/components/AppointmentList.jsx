    ...
    return (
        <Container className="p-2 ">
            ...
            {appointmentData.length < 1 && (
                <img src="./img/appointment.jpg" alt="" width="90%" />
            )}
            ...
            {appointmentData.map(({ id, client, completed, lawyer, day }) => (
                <div
                    className={
                        completed
                            ? "appointments consulted d-flex justify-content-between"
                            : "appointments d-flex justify-content-between"
                    }
                >
                    <div>
                        <h3>
                    ...
                    <div className="d-flex flex-column gap-4">
                        ...
                        <FaCheck
                            type="button"
                            className="text-success fs-3 icon"
